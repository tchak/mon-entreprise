...
const chainableMecanisms = [applicable, nonApplicable, plancher, plafond, arrondi]
function unfoldChainedMecanisms(rawNode) {
	return chainableMecanisms.reduceRight((node, parseFn) => {
	...
	}, omit(chainableMecanisms.map(fn => fn.nom), rawNode))
}
